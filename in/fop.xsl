        ...
        <fo:root font-family="Verdana" font-weight="normal">
            ...
            <fo:page-sequence master-reference="FOP" initial-page-number="1">
                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:block>
                        <xsl:for-each select="javaops:UsersWithMeals/javaops:Users/javaops:User">
                            <fo:block margin-top="10mm">
                                ...
                                <fo:block>
                                    Registered:&#160;<xsl:value-of select="format-dateTime(@registered, '[Y0001]-[M01]-[D01] [H01]:[m01]')"/>
                                </fo:block>
                                <fo:block>
                                    Roles:&#160;
                                    <xsl:choose>
                            ...
                            <fo:block>
                                <fo:table border="1pt solid black" margin-top="3mm">
                                    <fo:table-body>
                                        ...
                                        <xsl:for-each select="javaops:Meals/javaops:Meal">
                                            <fo:table-row text-align="center" font-size="10pt">
                                                <fo:table-cell border="1pt solid black" padding="1mm">
                                                    <fo:block>
                                                        <xsl:value-of select="format-dateTime(@dateTime, '[Y0001]-[M01]-[D01] [H01]:[m01]')"/>
                                                    </fo:block>
                                                </fo:table-cell>
                                                <fo:table-cell border="1pt solid black" padding="1mm">
                                                    <fo:block>
