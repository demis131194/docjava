...
import static ru.javaops.docjava.xml.xslt.SaxonUtil.toLocalDateTime;

public class GetExcessExtension implements ExtensionFunction {
    @Override
    public QName getName() {
        return new QName("javaops", "http://javaops.ru", "getExcess");
    }
    ...
    // Argument types: "javaops:getExcess(@dateTime)"
    @Override
