package ru.javaops.docjava.xml.xslt;
...
import static ru.javaops.docjava.xml.xslt.SaxonUtil.toLocalDate;
import static ru.javaops.docjava.xml.xslt.SaxonUtil.toLocalTime;

public class FilterMealsExtension implements ExtensionFunction {
    @Override
    public QName getName() {
        return new QName("javaops", "http://javaops.ru", "filter");
    }
